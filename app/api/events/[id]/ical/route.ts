...
/**
 * GET - Returns iCal (.ics) for the event.
 * Logged-in members: personalized ATTENDEE line if they RSVPed.
 * Public org guests: same calendar file without personal attendee row (read-only demo).
 */
