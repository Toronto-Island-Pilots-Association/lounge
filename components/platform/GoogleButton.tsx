...
export function GoogleButton({ redirectTo = '/platform/dashboard', className }: Props) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className={className ?? 'w-full flex items-center justify-center gap-3 bg-white border rounded-xl px-6 py-3 text-sm font-medium hover:bg-gray-50 transition-colors'}
    >
