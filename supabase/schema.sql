...
CREATE TABLE IF NOT EXISTS threads (
  ...
  category TEXT NOT NULL DEFAULT 'other' CHECK (category IN ('aircraft_shares', 'instructor_availability', 'gear_for_sale', 'flying_at_ytz', 'general_aviation', 'training_safety_proficiency', 'wanted', 'building_a_better_tipa', 'other')),
  created_by UUID REFERENCES auth.users(id) ON DELETE SET NULL,
